...
function Footer() {
  return (
    <footer className="border-t border-gray-200 bg-white">
      <div className="container mx-auto px-4 py-10 grid grid-cols-4 gap-8 items-start">
        <div>
          <div>
            <img className="w-27" src={Logo} alt="SevStack" />
            <p className="mt-3 max-w-xs leading-5 text-gray-500">
